...
![terraform init validate](docs/screenshots/terraform_init_validate.jpeg)

### Скріншот: terraform plan

![terraform plan](docs/screenshots/terraform_plan.jpeg)
...
![vm overview](docs/screenshots/vm_overview.jpeg)

![vm networking](docs/screenshots/vm_networking.jpeg)
...
![web quality](docs/screenshots/web_quality.png)

![web research](docs/screenshots/web_research.png)

![web plots](docs/screenshots/web_plots.png)
