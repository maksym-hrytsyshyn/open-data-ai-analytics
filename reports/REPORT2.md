...
![CI modules success](screenshots/ci_modules_success.png)

### CI (self-hosted) — виконання на локальному Mac
![CI self-hosted](screenshots/ci_selfhosted_success.png)

### Список збережених артефактів
![Artifacts](screenshots/artifacts.png)

### Ручний запуск з вибором модуля
![Manual trigger](screenshots/manual_trigger.png)
